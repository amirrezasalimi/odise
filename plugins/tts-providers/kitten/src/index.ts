...
export default class KittenTTSProvider extends TTSProvider {
    info: PluginInfo = {
        type: "tts",
        id: "kitten-tts",
        name: "Kitten TTS",
        author: "KittenML",
        authorUrl: "https://github.com/KittenML/kitten-tts",
        version: "1.0.0",
        description:
            "KittenTTS is a lightweight, on-device TTS model supporting efficient inference in the browser via ONNX WASM.",
    }
    options: TTSOptions = {
        ...
        defaultSpeakerId: "Jasper",
        defaultVariant: "nano-int8-15M",
        hasVariants: true,
        isLocal: true,
    };
    ...
    async load(variantId?: string, onProgress?: (progress: number) => void): Promise<void> {
        const targetVariantId = variantId ?? "nano-int8-15M";
    ...
    private async initializeWorker(
        variantId: string = "nano-int8-15M",
